...
async def _send_manual_intervention_notification(
    ...
    """
    try:
        from backend.dsl.services.email_service import send_task_failed_notification
...
async def run_codex_prd(
    ...
    try:
        ...
        try:
            from backend.dsl.services.email_service import send_prd_ready_notification
